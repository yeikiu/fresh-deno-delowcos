      ...
      <main class="-mt-12 sm:mt-0 sm:ml-24 text-gray-200">
          ...
          <section id="instalaciones">
            <div class="flex h-screen">
              <div class="m-auto text-center w-3/4 sm:w-1/2">
                <h1 class="text-4xl sm:text-5xl font-bold">Instalaciones</h1>
                
                <div class="my-6 h-px w-3/4 sm:w-1/2 mx-auto bg-white"></div>

                <ServicesList
                  services={[
                    "Estudio con cabina de grabación aislada",
                    "Sala de estar perfecta para descansar o componer",
                    "Climatización, nevera y cafetera ☕",
                    "Espacio con fondos tipo croma e iluminación regulable",
                    "Wifi (alta velocidad)",
                  ]}
                />
              </div>
        ...
        <HeroBackground bgImgUrl={asset('img/bg3.jpeg')}>
          <section id="servicios">
            <div class="flex h-screen">
              <div class="m-auto text-center w-3/4 sm:w-1/2">
                <h1 class="text-4xl sm:text-5xl font-bold">Servicios</h1>
          ...
          <section id="contacto">
            <div class="flex h-screen">
              <div class="m-auto text-center w-3/4">
                <h1 class="text-4xl sm:text-5xl font-bold">Contacto</h1>
                ...
                <h3 class="text-xl sm:text-2xl">
                  ...
                  <span class="font-bold">
                    teléfono, e-mail,{" "}
                    <span class="text-green-400">WhatsApp</span> o{" "}
                ...
                <div class="mt-12 h-px w-5/6 sm:w-3/4 mx-auto bg-white"></div>
                  <br />
                  <br />
                  <h3 class="text-xl sm:text-2xl">
